...
package com.xkcoding.rbac.shiro.config.bean;
...
public class StatelessAuthFilter extends AccessControlFilter {
    ...
    private void unionFailResponse(final ServletResponse response) throws IOException {
        ...
        DcsResult result = DcsResult.error(CommonErrorCode.TOKEN_ERROR,
                DcsResultMessage.TOKEN_IS_ERROR);
        httpResponse.getWriter().println(JSONUtil.toJsonStr(result));
    }
